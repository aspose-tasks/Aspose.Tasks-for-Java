...
public class ReadSpecificGanttChartData
{
    ...
    private static String[] barStylesNames = new String[]
            {
                    "Task", "Split", "Milestone", "Summary", "Project Summary", "*Group By Summary", "*Rolled Up Task", "*Rolled Up Split", "*Rolled Up Progress",
                    "*Rolled Up Milestone", "*Deliverable Start", "*Deliverable Finish","*Deliverable Duration","*Dependency Start","*Dependency Finish",
                    "*Dependency Duration","External Tasks","External Milestone","Deadline","Progress"
            };
    private static String[] barStylesShowFor = new String[]
            {
                    "Normal","Normal;Split","Milestone;Not Group By Summary","Summary","Project Summary","Group By Summary","Normal;Rolled Up;Not Summary",
                    "Normal;Rolled Up;Split;Not Summary","Normal;Rolled Up;Not Summary","Milestone;Rolled Up;Not Summary","Deliverable","Deliverable",
                    "Deliverable","Dependency","Dependency","Dependency","External Tasks;Not Milestone","Milestone;External Tasks","","Normal"
            };
    private static int[] barStylesFrom = new int[]
            {
                    Field.TaskStart,Field.TaskStart,Field.TaskFinish, Field.TaskStart,Field.TaskStart,Field.TaskStart,Field.TaskStart,Field.TaskStart,
                    Field.TaskStart, Field.TaskFinish, Field.TaskDeliverableStart, Field.TaskDeliverableFinish, Field.TaskDeliverableStart, Field.TaskDeliverableStart,
                    Field.TaskDeliverableFinish, Field.TaskDeliverableStart, Field.TaskStart, Field.TaskFinish, Field.TaskDeadline, Field.TaskActualStart
            };
    private static int[] barStylesTo = new int[]
            {
                    Field.TaskFinish, Field.TaskFinish, Field.TaskFinish, Field.TaskFinish, Field.TaskFinish, Field.TaskFinish, Field.TaskFinish, Field.TaskFinish,
                    Field.TaskCompleteThrough, Field.TaskFinish, Field.TaskDeliverableStart, Field.TaskDeliverableFinish, Field.TaskDeliverableFinish, Field.TaskDeliverableStart,
                    Field.TaskDeliverableFinish, Field.TaskDeliverableFinish, Field.TaskFinish, Field.TaskFinish, Field.TaskDeadline, Field.TaskCompleteThrough
            };
    private static int[] barStylesMiddleShape = new int[]
            {
                    GanttBarMiddleShape.RectangleBar, GanttBarMiddleShape.LineBottom, GanttBarMiddleShape.None, GanttBarMiddleShape.LineTop, GanttBarMiddleShape.LineTop,
                    GanttBarMiddleShape.RectangleMiddle, GanttBarMiddleShape.RectangleBar, GanttBarMiddleShape.LineBottom, GanttBarMiddleShape.RectangleMiddle, GanttBarMiddleShape.None,
                    GanttBarMiddleShape.None, GanttBarMiddleShape.None, GanttBarMiddleShape.LineBottom, GanttBarMiddleShape.None, GanttBarMiddleShape.None, GanttBarMiddleShape.LineTop,
                    GanttBarMiddleShape.RectangleBar, GanttBarMiddleShape.None, GanttBarMiddleShape.None, GanttBarMiddleShape.RectangleMiddle,
            };
    private static Color[] barStylesMiddleColor = new Color[]
            {
                    Color.blue, Color.blue, Color.black, Color.gray,  new Color(192,192,192), Color.gray, Color.blue,Color.blue, Color.blue, Color.black, Color.black, Color.black,
                    new Color(128,0,128), Color.black, Color.black, new Color(128,128,0),  new Color(192,192,192), Color.black, Color.black, Color.blue
            };
    private static int[] barStylesStartShape = new int[]
            {
                    GanttBarEndShape.NoBarEndShape, GanttBarEndShape.NoBarEndShape, GanttBarEndShape.Diamond, GanttBarEndShape.LineShape, GanttBarEndShape.LineShape,
                    GanttBarEndShape.LineShape, GanttBarEndShape.NoBarEndShape, GanttBarEndShape.NoBarEndShape, GanttBarEndShape.NoBarEndShape, GanttBarEndShape.Diamond,
                    GanttBarEndShape.LineShape, GanttBarEndShape.NoBarEndShape, GanttBarEndShape.NoBarEndShape, GanttBarEndShape.LineShape, GanttBarEndShape.NoBarEndShape,
                    GanttBarEndShape.NoBarEndShape, GanttBarEndShape.NoBarEndShape, GanttBarEndShape.Diamond, GanttBarEndShape.ArrowDown, GanttBarEndShape.NoBarEndShape,
            };
    private static int[] barStylesEndShape =new int[]
            {
                    GanttBarEndShape.NoBarEndShape, GanttBarEndShape.NoBarEndShape, GanttBarEndShape.NoBarEndShape, GanttBarEndShape.LineShape, GanttBarEndShape.LineShape,
                    GanttBarEndShape.LineShape, GanttBarEndShape.NoBarEndShape, GanttBarEndShape.NoBarEndShape, GanttBarEndShape.NoBarEndShape, GanttBarEndShape.NoBarEndShape,
                    GanttBarEndShape.NoBarEndShape, GanttBarEndShape.LineShape, GanttBarEndShape.NoBarEndShape, GanttBarEndShape.NoBarEndShape, GanttBarEndShape.LineShape,
                    GanttBarEndShape.NoBarEndShape, GanttBarEndShape.NoBarEndShape, GanttBarEndShape.NoBarEndShape, GanttBarEndShape.NoBarEndShape, GanttBarEndShape.NoBarEndShape
            };
    private static Color[] barStylesEndShapeColor = new Color[]
            {
                    Color.black, Color.black, Color.black, new Color(128,128,128),  new Color(192,192,192),new Color(128,128,128), Color.black, Color.black, Color.black, Color.black, Color.black,
                    new Color(128,0,128), Color.black, Color.black, new Color(128,128,0), Color.black, Color.black, Color.black, Color.black, Color.black
            };
}
