...
package programmersguide.workingwithtasks.task'stimephaseddata.java;

import com.aspose.tasks.*;

public class Task'sTimephasedData
{
    public static void main(String[] args) throws Exception
    {
        // The path to the documents directory.
	String dataDir = "src/programmersguide/workingwithtasks/task'stimephaseddata/data/";  
