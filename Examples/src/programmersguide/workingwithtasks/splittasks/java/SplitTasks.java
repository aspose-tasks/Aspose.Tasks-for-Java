...
package programmersguide.workingwithtasks.splittasks.java;
...
public class SplitTasks
{
	...
	String dataDir = "src/programmersguide/workingwithtasks/splittasks/data/";  
	...
	//Save the Project
	splitTaskProject.save("Project.Xml", SaveFileFormat.XML);
