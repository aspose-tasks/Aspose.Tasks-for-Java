...
package programmersguide.workingwithcalendars.updatedcalendartompp.java;
...
public class UpdatedCalendarToMpp
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/workingwithcalendars/updatedcalendartompp/data/";

	WriteUpdatedCalenderDataToMPP();
	//Display result of conversion.
        System.out.println("Process completed Successfully");
    }
	
    static void WriteUpdatedCalendarDataToMPP()
