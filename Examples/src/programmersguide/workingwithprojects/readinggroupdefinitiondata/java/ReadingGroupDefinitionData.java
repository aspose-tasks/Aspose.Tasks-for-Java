...
package programmersguide.workingwithprojects.readinggroupdefinitiondata.java;
...
public class ReadingGroupDefinitionData
{
    public static void main(String[] args) throws Exception
    {
        // The path to the documents directory.
        String dataDir = "src/programmersguide/workingwithprojects/readinggroupdefinitiondata/data/";
