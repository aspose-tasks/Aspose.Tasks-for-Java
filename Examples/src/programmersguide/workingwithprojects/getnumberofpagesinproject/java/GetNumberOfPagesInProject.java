...
package programmersguide.workingwithprojects.getnumberOfpagesinproject.java;
...
public class GetNumberOfPagesInProject
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/workingwithprojects/getnumberOfpagesinproject/data/";
