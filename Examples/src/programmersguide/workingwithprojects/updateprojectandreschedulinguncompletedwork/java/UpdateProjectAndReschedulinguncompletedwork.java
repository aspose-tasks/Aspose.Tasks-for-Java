...
package programmersguide.workingwithprojects.updateprojectandreschedulinguncompletedwork.java;
...
public class UpdateProjectAndReschedulingUncompletedWork
{
    public static void main(String[] args) throws Exception
    {
        // The path to the documents directory.
        String dataDir = "src/programmersguide/workingwithprojects/updateprojectandreschedulinguncompletedwork/data/";
	...
	project.save("not updated.xml", SaveFileFormat.XML);
	...
	project.save("rescheduled.xml", SaveFileFormat.XML);
