...
package programmersguide.workingwithprojects.retrieveoutlinecodes.java;
...
public class RetrieveOutlineCodes
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/workingwithprojects/retrieveoutlinecodes/data/";
    ...
    {
       Project project = new Project("OutlineCodes.mpp");
